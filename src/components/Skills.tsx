        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4 sm:gap-6 max-w-4xl mx-auto">
            {technologies.map((tech) => (
              ...
              >
                <div
                  className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 flex items-center justify-center rounded-lg shadow-xl transition-all duration-300 hover:scale-110 overflow-hidden"
                  style={{
                    backgroundColor: "var(--glass-bg)",
